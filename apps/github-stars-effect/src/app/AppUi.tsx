...
export const AppUi = () => {
  ...
  const [queryString, setQueryString] = useState('effect');

  const query = useQuery({
    queryKey: ['search-stars', queryString],
    queryFn: fetchStars,
  });
  ...
  return (
    ...
    >
      <View style={styles.section}>
        <TextInput
          value={queryString}
          onChangeText={(str) => setQueryString(str)}
        />
      ...
      >
        <View style={styles.shadowBox}>
          ...
          <View style={[styles.codeBlock, styles.marginBottomLg]}>
            <Text style={[styles.textXS, styles.monospace]}>
              nx show project GithubStarsEffect --web
            </Text>
          </View>
          <View style={styles.listItem}>
            <Svg
